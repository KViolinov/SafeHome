...
# Function to stop video stream after 10 seconds
def stop_video_stream_after_timeout():
    global video_streaming
    time.sleep(10)  # Wait for 10 seconds
    video_streaming = False
    print("Video stream stopped after 10 seconds.")
...
# Start the timer to stop the video stream after 10 seconds
timer_thread = threading.Thread(target=stop_video_stream_after_timeout)
